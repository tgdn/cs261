...
class ServiceClient(object):
    """A generic service client. Override this with your own client with specialized functions."""
    ...
    def GET(self, url, data=None):
        ...
        return self.network_wrapper.GET(self.endpoint + url, data)

    def POST(self, url, data=None):
        """Prepends self.endpoint to the url and issues a POST request."""
        return self.network_wrapper.POST(self.endpoint + url, data)

    def PUT(self, url, data=None):
        """Prepends self.endpoint to the url and issues a PUT request."""
        return self.network_wrapper.PUT(self.endpoint + url, data)

    def DELETE(self, url, data=None):
        """Prepends self.endpoint to the url and issues a DELETE request."""
        return self.network_wrapper.DELETE(self.endpoint + url, data)
