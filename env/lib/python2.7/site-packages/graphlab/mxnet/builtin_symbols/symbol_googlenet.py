...
def get_symbol(num_classes = 1000):
    ...
    pool1 = symbol.Pooling(conv1, kernel=(3, 3), stride=(2, 2), pool_type="max")
    ...
    pool3 = symbol.Pooling(conv3, kernel=(3, 3), stride=(2, 2), pool_type="max")
    ...
    pool4 = symbol.Pooling(in3b, kernel=(3, 3), stride=(2, 2), pool_type="max")
    ...
    pool5 = symbol.Pooling(in4e, kernel=(3, 3), stride=(2, 2), pool_type="max")
    ...
    pool6 = symbol.Pooling(in5b, kernel=(7, 7), stride=(1,1), pool_type="avg")
    flatten = symbol.Flatten(data=pool6)
    fc1 = symbol.FullyConnected(data=flatten, num_hidden=num_classes)
